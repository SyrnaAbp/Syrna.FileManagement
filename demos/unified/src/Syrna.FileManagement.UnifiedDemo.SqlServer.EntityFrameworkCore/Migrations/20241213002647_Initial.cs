...
namespace Syrna.FileManagement.UnifiedDemo.SqlServer.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SyrnaFileManagementFiles",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FileContainerName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    HasSubdirectories = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Flag = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SoftDeletionToken = table.Column<string>(type: "nvarchar(450)", nullable: true, defaultValue: ""),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyrnaFileManagementFiles", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SyrnaFileManagementUsers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyrnaFileManagementUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyrnaFileManagementFiles_BlobName",
                table: "SyrnaFileManagementFiles",
                column: "BlobName");

            migrationBuilder.CreateIndex(
                name: "IX_SyrnaFileManagementFiles_FileName_ParentId_OwnerUserId_FileContainerName_TenantId_SoftDeletionToken",
                table: "SyrnaFileManagementFiles",
                columns: new[] { "FileName", "ParentId", "OwnerUserId", "FileContainerName", "TenantId", "SoftDeletionToken" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyrnaFileManagementFiles_Hash",
                table: "SyrnaFileManagementFiles",
                column: "Hash");

            migrationBuilder.CreateIndex(
                name: "IX_SyrnaFileManagementFiles_ParentId_OwnerUserId_FileContainerName_FileName",
                table: "SyrnaFileManagementFiles",
